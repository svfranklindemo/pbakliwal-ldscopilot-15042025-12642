...
if (getMetadata('target')) {
  atjsPromise = initATJS('./at.fix.min.js', {
    clientCode: 'adobedemoamericas256',
    serverDomain: 'adobedemoamericas256.tt.omtrdc.net',
...
let alloyLoadedPromise = initWebSDK('./analytics/alloy.js', {
  datastreamId: 'e039d375-5334-4161-9fab-706600f5d2ce',
  orgId: 'adobedemoamericas256@AdobeOrg',
});
